...
class CacheableNavigation_Rebuild extends BuildTask {
     ...
     * 
     * @todo what happens if the total number of pages is less that this number?
     * @var number
     */
    ...
    public function run($request) {
        ...
        $this->showConfig($totalTime, $request);
    }
    
    /**
     * 
     * Returning boolean true|false this methd dictates what gets queued and when.
     * 
